                ...
                if (ranking != 0) {
                    if (totalOrgRankings[ranking - 1].token_sum == it.token_sum) {
                        totalOrgRankings.add(
                            com.dragonguard.android.data.model.rankings.TotalOrganizationModel(
                                it.email_endpoint,
                                it.id,
                                it.name,
...
//                    .into(binding.firstProfile)
    ...
    private fun profileOrg(model: com.dragonguard.android.data.model.rankings.TotalOrganizationModel): Int {
